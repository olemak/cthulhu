...
const copy = {
    ...
    subscribe:  '<h2>GM options</h2><p>I\'ve been thinking about making some additional features for groups, such as character sharing, network saving (so your characters are available from multiple devices) and so on.</p>'
  }
